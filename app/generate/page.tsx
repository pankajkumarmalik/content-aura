...
export default function GenerateContent() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      let promptText = `Write an engaging, human-like ${contentType} post about "${prompt}" that feels authentic, relatable, and compelling. Use a natural tone, emotional appeal, and keep it concise yet impactful.`;

      if (contentType === "twitter") {
        promptText +=
          " Generate exactly 5 tweets as a thread. Do not include any introduction, explanation, or extra text—only the tweets themselves, each under 280 characters.";
      }
      ...
      if (contentType === "instagram" && image) {
        ...
        promptText +=
          " Generate a single, engaging Instagram caption based on the image and prompt. Keep it short, natural, and creative, without numbering or multiple options.";
      }
              ...
              <div>
                ...
                <Select
                  onValueChange={(value) => {
                    ...
                    setGeneratedContent([]); // Reset generated content when type changes
                  }}
                ...
                >
                  ...
                  <SelectContent className="bg-gray-800 border border-gray-700 text-gray-300 rounded-xl shadow-lg">
                    {contentTypes.map((type) => (
                      <SelectItem
                        key={type.value}
                        value={type.value}
                        className="data-[highlighted]:bg-gray-700 data-[highlighted]:text-gray-200 transition-colors"
                      >
                        <div className="flex items-center">
                          {type.value === "twitter" && (
